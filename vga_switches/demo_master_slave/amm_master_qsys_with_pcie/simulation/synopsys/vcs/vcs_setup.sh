...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_router_004.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_router_002.sv \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_004.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_003.sv \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_002.sv \
  ...
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_vga_controller_0.v \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_rgb_resampler_0.v \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_pixel_buffer_dma_0.v \
  $QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_dual_clock_buffer_0.v \
