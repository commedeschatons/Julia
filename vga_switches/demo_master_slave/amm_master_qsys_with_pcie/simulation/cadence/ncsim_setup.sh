...
mkdir -p ./libraries/pcie_ip_bar1_0_cmd_width_adapter/
mkdir -p ./libraries/rsp_mux_001/
mkdir -p ./libraries/cmd_mux_001/
mkdir -p ./libraries/cmd_demux_002/
mkdir -p ./libraries/cmd_demux_001/
mkdir -p ./libraries/sdram_s1_burst_adapter/
mkdir -p ./libraries/video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                                          -cdslib ./cds_libs/error_adapter_0.cds.lib                                         
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_avalon_st_adapter.v"                  -work avalon_st_adapter                                        -cdslib ./cds_libs/avalon_st_adapter.cds.lib                                       
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_router_004.sv"                        -work router_004                                               -cdslib ./cds_libs/router_004.cds.lib                                              
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2_router_002.sv"                        -work router_002                                               -cdslib ./cds_libs/router_002.cds.lib                                              
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                                   -work pcie_ip_bar1_0_cmd_width_adapter                         -cdslib ./cds_libs/pcie_ip_bar1_0_cmd_width_adapter.cds.lib                        
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                               -work pcie_ip_bar1_0_cmd_width_adapter                         -cdslib ./cds_libs/pcie_ip_bar1_0_cmd_width_adapter.cds.lib                        
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                              -work pcie_ip_bar1_0_cmd_width_adapter                         -cdslib ./cds_libs/pcie_ip_bar1_0_cmd_width_adapter.cds.lib                        
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                                 -work video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter -cdslib ./cds_libs/video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                                  -work video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter -cdslib ./cds_libs/video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                          -work video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter -cdslib ./cds_libs/video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                                 -work video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter -cdslib ./cds_libs/video_pixel_buffer_dma_0_avalon_pixel_dma_master_limiter.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_004.sv"                        -work router_004                                               -cdslib ./cds_libs/router_004.cds.lib                                              
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_002.sv"                        -work router_002                                               -cdslib ./cds_libs/router_002.cds.lib                                              
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_vga_controller_0.v"                               -work video_vga_controller_0                                   -cdslib ./cds_libs/video_vga_controller_0.cds.lib                                  
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_rgb_resampler_0.v"                                -work video_rgb_resampler_0                                    -cdslib ./cds_libs/video_rgb_resampler_0.cds.lib                                   
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_pixel_buffer_dma_0.v"                             -work video_pixel_buffer_dma_0                                 -cdslib ./cds_libs/video_pixel_buffer_dma_0.cds.lib                                
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_video_dual_clock_buffer_0.v"                            -work video_dual_clock_buffer_0                                -cdslib ./cds_libs/video_dual_clock_buffer_0.cds.lib                               
