...
module julia_wrapper
  (
   ...
   input logic 		     start_sig,		//starts design
   input logic 		     wait_request,	//input from avalon bus
   input logic signed [21:0] a,			//real component of the input parameter
   input logic signed [21:0] b,			//imaginary component of the input parameter

   output logic [31:0] 	     wr_addr,		//address to write to
   output logic [31:0] 	     wr_data,		//data to write
   output logic 	     wr_enable		//write enable signal to avalon slave
...
logic [9:0] x_reg [15:0];			//stores all x values
...
//always @(posedge disp_jw_start)
   ...
   assign addr_1D = {addr_reg[15] ,addr_reg[14],addr_reg[13],addr_reg[12],addr_reg[11],addr_reg[10],addr_reg[9],addr_reg[8],addr_reg[7],addr_reg[6],addr_reg[5],addr_reg[4],addr_reg[3],addr_reg[2],addr_reg[1],addr_reg[0]};		//2d array to 1d array
   assign color_1D = {color_reg[15] ,color_reg[14],color_reg[13],color_reg[12],color_reg[11],color_reg[10],color_reg[9],color_reg[8],color_reg[7],color_reg[6],color_reg[5],color_reg[4],color_reg[3],color_reg[2],color_reg[1],color_reg[0]};   	//2d array to 1d array
   
   mem MEM				//Memory Controller
     (
      .clk(clk),
      .n_rst(n_rst),
   ...
   julia_worker JW0			//Julia Worker 0-15
     (
      .clk(clk),
      .n_rst(n_rst),
      .x(x_reg[0]),
